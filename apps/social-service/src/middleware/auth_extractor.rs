...
use crate::error::{internal, unauthorized, RhelmaErrorResponse};
...
where
    S: Send + Sync,
{
    type Rejection = RhelmaErrorResponse;
...
mod tests {
    ...
    #[test]
    fn extract_bearer_accepts_lowercase() {
