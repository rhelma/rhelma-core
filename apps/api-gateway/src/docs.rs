...
///
/// - Default build: serves the checked-in contract file.
...
pub async fn docs_landing() -> impl IntoResponse {
    ...
    Build `api-gateway` with <code>--features openapi</code> to enable it.
  </p>"#
    };
