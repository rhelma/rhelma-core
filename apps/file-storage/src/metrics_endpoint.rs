...
//! Prometheus `/metrics` endpoint for file-storage.
//!
//! `rhelma-observability-core` initializes unified tracing/metrics, but it does not
//! guarantee an HTTP scrape endpoint. This module wires an optional Prometheus
//! exporter and exposes a handler that always returns 200.
...
pub fn init_prometheus_recorder() {
    ...
    match builder.install_recorder() {
        Ok(handle) => {
            ...
            info!("prometheus recorder installed (file-storage)");
        }
        Err(e) => {
