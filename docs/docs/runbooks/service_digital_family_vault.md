# Service Runbook: digital-family-vault (Rhelma6)

## What this service does

digital-family-vault is a Rhelma6 component. For intent, configuration, and API/event contracts, see:

- `apps/digital-family-vault/README.md`
...
```bash
kubectl get pods -n rhelma6 -l app=digital-family-vault -o wide
kubectl logs -n rhelma6 -l app=digital-family-vault --tail=200
...
```bash
kubectl rollout restart deploy/digital-family-vault -n rhelma6
kubectl rollout status deploy/digital-family-vault -n rhelma6 --timeout=180s
```

### Roll back a bad release

```bash
kubectl rollout undo deploy/digital-family-vault -n rhelma6
kubectl rollout status deploy/digital-family-vault -n rhelma6 --timeout=180s
```
...
- Scale horizontally:
  ```bash
  kubectl scale deploy/digital-family-vault -n rhelma6 --replicas=4
  ```
