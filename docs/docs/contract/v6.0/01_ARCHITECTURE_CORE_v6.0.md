# Contract v6.0 — Core architecture
...
## 2. RequestContext v6.0 ⚠️ BREAKING CHANGE
...
## 6. Configuration Management v6.0
...
See **A1_SLA_MATRIX_v6.0.md** for complete specifications.

---

## 9. Compliance Requirements

A service is **Architecture Core v6.0 Compliant** if:

✅ Implements RequestContext v6.0  
✅ Uses structured error model v6.0  
