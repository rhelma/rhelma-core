...
5. **All signals MUST link through RequestContext v6.0**
...
| `request_id` | YES | From RequestContext v6.0 |
...
See **04_EVENT_DRIVEN_v6.0.md** for complete `ops.audit@v2` schema.
...
## 9. AI Observability Extensions (v6.0)
...
A service is **Observability v6.0 Compliant** if:
...
✅ HTTP Contract v6.0 enforced at ingress (x-rhelma-request-id, x-rhelma-correlation-id, x-residency, traceparent) and guarded by automated conformance tests (Phase 80)  

---

**End of Observability v6.0**