# Contract v6.0 — Disaster recovery
...
8. **AI incident systems MUST recover gracefully** (NEW v6.0)
...
- Incident analysis state (NEW v6.0)
...
A system is **DR v6.0 Compliant** if:
